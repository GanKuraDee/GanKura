...
public class CritterCaptureHud extends HudElement {
    ...
    public void renderElement(GuiGraphicsExtractor graphics, boolean isPreview) {
        ...
        text(graphics, font, "§b§lWumpa Status", 0, 0, 0xFFFFFFFF, true);
        ...
        text(graphics, font, countLine, 0, LINE_HEIGHT, 0xFFFFFFFF, true);
        ...
        for (int i = 0; i < critters.size(); i++) {
            ...
            text(graphics, font, mark + " " + (done ? "§f" : "§7") + critter, 0, y, 0xFFFFFFFF, true);
            y += LINE_HEIGHT;
        }
    }

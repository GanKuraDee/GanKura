...
public class DayHud extends HudElement {
    public DayHud() {
        super("day", 10, 62, 1.0f, 60, 15, () -> ModConfig.GeneralHud.showDayHud, () -> true);
    }
    ...
    public void renderElement(GuiGraphicsExtractor graphics, boolean isPreview) {
        ...
        if (ModConfig.Combat.TheEnd.enableDay30Alert && isTargetMap && day >= 30 && ModConstants.STAGE_AWAKENING.equals(GameState.Golem.stage)) {
            color = 0xFFFF5555;
        }

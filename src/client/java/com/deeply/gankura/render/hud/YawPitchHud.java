...
public class YawPitchHud extends HudElement {
    ...
    public YawPitchHud() {
        super("yawPitch", 460, 160, 1.0f, 80, 20,
                () -> ModConfig.GeneralHud.showYawPitchHud, () -> true);
    }
    ...
    public void renderElement(GuiGraphicsExtractor graphics, boolean isPreview) {
        ...
        text(graphics, font, "§bYaw: §f" + format(yaw, ModConfig.GeneralHud.yawPrecision), 0, 0, 0xFFFFFFFF, true);
        text(graphics, font, "§bPitch: §f" + format(pitch, ModConfig.GeneralHud.pitchPrecision), 0, 10, 0xFFFFFFFF, true);
    }

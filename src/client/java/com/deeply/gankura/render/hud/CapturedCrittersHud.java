...
public class CapturedCrittersHud extends HudElement {
    ...
    public void renderElement(DrawContext context, boolean isPreview) {
        ...
        for (Column column : COLUMNS) {
            ...
            drawTextWithShadow(context, font, heading, x, LINE_HEIGHT, 0xFFFFFFFF);

            int columnWidth = font.getWidth(heading);
            int y = FIRST_LINE_Y;
            ...
            for (int i = 0; i < critters.size(); i++) {
                ...
                drawTextWithShadow(context, font, line, x, y, 0xFFFFFFFF);
                columnWidth = Math.max(columnWidth, font.getWidth(line));
                y += LINE_HEIGHT;
            }
        ...
        drawTextWithShadow(context, font, "§6§lCaptured Critters §r§7- §e" + done + "§7/§e" + total, 0, 0, 0xFFFFFFFF);
    }

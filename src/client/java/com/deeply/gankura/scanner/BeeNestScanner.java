...
public class BeeNestScanner {
    ...
    public static boolean isActive() {
        ...
        return client.player != null && EntityHighlightManager.inSafariForest(client.player.getBlockPos());
    }
    ...
    private static void scan(MinecraftClient client) {
        ...
        if (!EntityHighlightManager.inSafariForest(client.player.getBlockPos())) {
    ...
    private static void collectFromChunk(WorldChunk chunk, int originX, int originZ, Set<BlockPos> found) {
        ...
        for (int index = 0; index < sections.length; index++) {
            ...
            if (section.isEmpty() || !section.hasAny(IS_BEE_NEST)) continue;

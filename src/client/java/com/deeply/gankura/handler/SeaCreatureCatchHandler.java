...
public class SeaCreatureCatchHandler {
     ...
     */
    public static boolean handleMessage(String unformattedMsg, MinecraftClient client) {
     ...
     */
    private static boolean shorten(MinecraftClient client, SeaCreatureCatches.Catch caught, boolean doubleHook) {

...
public class GameState {
    ...
    public static class Arachne {
        ...
        public static boolean unknownBigSpawn = false; // Sanctuary外でArachne Crystalを検知し、観測できずUnknown扱いにしている間 true
        public static void reset() {
            ...
            awaitingCrystalParticles = false; crystalMessageTime = 0; particleBurstCounter = 0; unknownBigSpawn = false;
        }
    }

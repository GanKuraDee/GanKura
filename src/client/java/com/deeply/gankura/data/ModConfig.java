...
public class ModConfig extends Config {
    ...
    public static class MiscCategory {
        ...
        @Expose
        @ConfigOption(name = "Armor HUD Orientation", desc = "Expand to choose the armor HUD's layout.")
        ...
        @Expose
        @ConfigOption(name = "Orientation", desc = "Lays the armor HUD out horizontally or vertically.")
        ...
        @Expose
        @ConfigOption(name = "Equipment HUD Orientation", desc = "Expand to choose the Equipment HUD's layout.")
        ...
        @Expose
        @ConfigOption(name = "Orientation", desc = "Lays the Equipment HUD out horizontally or vertically.")
        @ConfigEditorDropdown
